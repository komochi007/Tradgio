...
import { getPurchaseOrder } from "../application/purchaseService"
import type { PurchaseOrder } from "../domain/types"
import { buildPurchaseExportPayload } from "../../../export-service/application/buildExportPayload"
    ...
    return (
      <div className="list-page">
        <div className="page-header">
          <h1 className="page-title">进货单详情</h1>
        </div>
        <SkeletonCard />
      </div>
    )
    ...
    <div className="list-page">
      <div className="page-header">
        ...
        <div className="topbar__actions">
          ...
          <Button variant="primary" onClick={() => navigate(`/purchases/${order.id}/edit`)}>
            编辑
          </Button>
        </div>
      </div>
      ...
      <SectionCard eyebrow="基本信息" title="供应商与日期">
        <div className="detail-grid">
          ...
          <div className="detail-item">
            <span className="detail-item__label">供应商</span>
            <span className="detail-item__value">{order.supplierName}</span>
          </div>
          <div className="detail-item">
