...
- 生产化路线图已建立；任务 35-42 的契约、本地安全 Auth、业务 IndexedDB、附件 Blob、离线导出和整机加密备份恢复已完成，当前下一任务为任务 43
...
详细依赖和验收标准以 `tasks/production-roadmap.md` 为准。当前不实施云端供应商 SDK，下一步完成任务 43 的本地生产适配层自动化回归。
...
- 整机加密备份恢复已实现；PWA 更新和 Windows 恢复演练尚未完成
